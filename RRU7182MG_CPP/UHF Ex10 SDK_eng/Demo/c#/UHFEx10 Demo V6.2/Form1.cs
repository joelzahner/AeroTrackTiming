...
namespace UHFEx10Demo
{
    public partial class Form1 : Form
    {
        ...
        public void PresetTarget(int readMode, int SelectAntenna)
        {
            ...
            if (readMode > 0)
            {
                ...
                else if (readMode==255)
                {
                    ...
                    for (int m = 0; m < 2; m++)
                    {
                        fCmdRet = RWDev.SelectCMDByAntenna(ref fComAdr, SelectAntenna, AntennaNum, CurSession, ACTION, MaskMem, MaskAdr, MaskLen, MaskData, 0, frmcomportindex);
                        Thread.Sleep(5);
                    }
                    CurSession = (byte)3;
                    for (int m = 0; m < 2; m++)
        ...
        private void flash_G2()
        {
            ...
            if ((fCmdRet == 1) || (fCmdRet == 2) || (fCmdRet == 0xFB) || (fCmdRet == 0x26))
            {
                ...
                if (cmdTime > 0)
                {
                    ...
                    ptrWnd = FindWindow(null, "UHF Ex10 Demo V6.2");
                    if (ptrWnd != IntPtr.Zero)         // 检查当前统计窗口是否打开
                    {
            ...
            ptrWnd1 = FindWindow(null, "UHF Ex10 Demo V6.2");
        ...
        private void radioButton_band3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < 6; i++)
            {
                ComboBox_dminfre.Items.Add(Convert.ToString(917.3 + i * 0.6) + " MHz");
                ComboBox_dmaxfre.Items.Add(Convert.ToString(917.3 + i * 0.6) + " MHz");
                cmbReturnLossFreq.Items.Add(Convert.ToString(917.3 + i * 0.6));
            }
            ComboBox_dmaxfre.SelectedIndex = 5;
            ComboBox_dminfre.SelectedIndex = 0;
            cmbReturnLossFreq.SelectedIndex = 2;
        }
        ...
        private void radioButton_band4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < 4; i++)
            {
                ComboBox_dminfre.Items.Add(Convert.ToString(865.7 + i * 0.6) + " MHz");
                ComboBox_dmaxfre.Items.Add(Convert.ToString(865.7 + i * 0.6) + " MHz");
                cmbReturnLossFreq.Items.Add(Convert.ToString(865.7 + i * 0.6));
            }
            ComboBox_dmaxfre.SelectedIndex = 3;
            ComboBox_dminfre.SelectedIndex = 0;
            cmbReturnLossFreq.SelectedIndex = 2;
        }
        ...
        private void Maintab_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (frmcomportindex>0 && tabControl1.SelectedIndex==1)
            {
        ...
        private void btGetInformation_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                panel12.Enabled = false;
                if (ReaderType == 0x71 || ReaderType == 0x31 || ReaderType == 0x70
                    || ReaderType == 0x72 || ReaderType == 0x5F || ReaderType == 0x7F
                    || ReaderType == 0x76 || ReaderType == 0x56 || ReaderType == 0x38
                    || ReaderType == 0x57 || ReaderType == 0x77 || ReaderType == 0x39
                    || ReaderType == 0x55 || ReaderType == 0x75 || ReaderType == 0x35 
                    || ReaderType == 0x33 || ReaderType == 0x53 || ReaderType == 0x73
                    || ReaderType == 0x3A || ReaderType == 0x5A || ReaderType == 0x7A
                    || ReaderType == 0x3B || ReaderType == 0x5B || ReaderType == 0x7B
                    || ReaderType == 0x3C || ReaderType == 0x5C || ReaderType == 0x7C
                    || ReaderType == 0x3D || ReaderType == 0x5D || ReaderType == 0x7D
                    ...
                    || ReaderType == 0x2A || ReaderType == 0x2B || ReaderType == 0x2C
                    || ReaderType == 0x2D || ReaderType == 0x2E || ReaderType == 0x2F
                    || ReaderType == 0x6D || ReaderType == 0x6E || ReaderType == 0x6F
                    || ReaderType == 0xA0 || ReaderType == 0xA1 || ReaderType == 0xA2
                    || ReaderType == 0x78 || ReaderType == 0x96 || ReaderType == 0x97)//Ex10
                {
                    ModeType = 2;
                    panel12.Enabled = true;
                    ...
                    case 0x78:
                        {
                            ...
                            else if (ReaderType == 0x78)
                            {
                                text_RDVersion.Text = "UHF9182M--" + Convert.ToString(VersionInfo[0], 10).PadLeft(2, '0') + "." + Convert.ToString(VersionInfo[1], 10).PadLeft(2, '0');
                            }
                            else
                            {
                    ...
                    case 0x7F:
                        {
                            ...
                            else if (ReaderType == 0x6D)
                            {
                                text_RDVersion.Text = "UHF363M--" + Convert.ToString(VersionInfo[0], 10).PadLeft(2, '0') + "." + Convert.ToString(VersionInfo[1], 10).PadLeft(2, '0');
                            }
                            else if (ReaderType == 0x6E)
                            {
                                text_RDVersion.Text = "UHF563M--" + Convert.ToString(VersionInfo[0], 10).PadLeft(2, '0') + "." + Convert.ToString(VersionInfo[1], 10).PadLeft(2, '0');
                            }
                            else if (ReaderType == 0x6F)
                            {
                                text_RDVersion.Text = "UHF763M--" + Convert.ToString(VersionInfo[0], 10).PadLeft(2, '0') + "." + Convert.ToString(VersionInfo[1], 10).PadLeft(2, '0');
                            }
                    ...
                    case 0x97:
                        {
                            ...
                            else if (ReaderType == 0x97)
                            {
                                text_RDVersion.Text = "UHF9199M--" + Convert.ToString(VersionInfo[0], 10).PadLeft(2, '0') + "." + Convert.ToString(VersionInfo[1], 10).PadLeft(2, '0');
                            }
                            else
                            {
                    ...
                    case 0x96:
                        {
                            ...
                            else if (ReaderType == 0x96)
                            {
                                text_RDVersion.Text = "UHF9189M--" + Convert.ToString(VersionInfo[0], 10).PadLeft(2, '0') + "." + Convert.ToString(VersionInfo[1], 10).PadLeft(2, '0');
                            }
                            else
                            {
                ...
                if ((dmaxfre == 255) && (dminfre == 255))
                {
                    ...
                    fCmdRet = RWDev.ExtGetRegion(ref fComAdr,ref FreBand,ref dmaxfre,ref dminfre,frmcomportindex);
                    if (fCmdRet==0)
                    {
                        switch (FreBand)
                        {
                            case 17:
                                {
                                    ...
                                    fdminfre = 75 + (dminfre & 0x3F) * 0.5;
                                    fdmaxfre = 75 + (dmaxfre & 0x3F) * 0.5;
                                }
                                break;
                        }
                        ...
                        case 9:
                            {
                                ...
                                fdminfre = 865.7 + (dminfre & 0x3F) * 0.6;
                                fdmaxfre = 865.7 + (dmaxfre & 0x3F) * 0.6;
                            }
                            break;
                        case 8:
                            {
        ...
        private void btFreq_Click(object sender, EventArgs e)
        {
            ...
            {
                dminfre = (byte)ComboBox_dminfre.SelectedIndex;
                dmaxfre = (byte)ComboBox_dmaxfre.SelectedIndex;
                fCmdRet = RWDev.ExtSetRegion(ref fComAdr,(byte)0, (byte)band, dmaxfre, dminfre, frmcomportindex);
            }
        ...
        private void radioButton_band0_CheckedChanged(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < 14; i++)
            {
                ComboBox_dminfre.Items.Add(Convert.ToString(920.75 + i * 0.5) + " MHz");
                ComboBox_dmaxfre.Items.Add(Convert.ToString(920.75 + i * 0.5) + " MHz");
                cmbReturnLossFreq.Items.Add(Convert.ToString(920.75 + i * 0.5));
            }
            ComboBox_dmaxfre.SelectedIndex = 13;
            ComboBox_dminfre.SelectedIndex = 0;
            cmbReturnLossFreq.SelectedIndex = 6;
        }
        ...
        //private static readonly int BroadcastPort = 65535;
        private static readonly IPAddress BroadcastAddress = IPAddress.Parse("255.255.255.255"); // 对于IPv4，使用这个广播地址
        private static UdpClient udpClient;
        /* private void ReceiveCallback(IAsyncResult ar)
         {
             // 使用 UdpClient.EndReceive 方法结束异步接收操作
             // 并获取发送方的 IP 和端口信息
             ...
             if (receivedString.Length > 5)
             {
                 ...
                 this.Invoke((EventHandler)delegate
                 {
                     ...
                     aListItem.SubItems.Add("");
                     aListItem.SubItems.Add(""); ;
                     if (receivedString.Substring(0, 1) == "A")
                     {
                         int m = receivedString.IndexOf('/');
                         Information.mac = receivedString.Substring(1, m - 1);
                         Information.portnum = receivedString.Substring(m + 1, 4);
                         m = receivedString.IndexOf('*');
                         int n = receivedString.Length - m - 8;
                         string IDPstring = receivedString.Substring(m + 8, n);
                         ...
                         Information.IP = Sender.ToString().Substring(0, Sender.ToString().IndexOf(':'));
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int randomNumber = random.Next(0,1000);  // 生成一个非负的32位有符号整数
                udpClient = new UdpClient(11000+ randomNumber);
                ...
                EndPoint endPoint = sock.LocalEndPoint;
                ...
                IPEndPoint iep = new IPEndPoint(IPAddress.Broadcast, 65535);//初始化一个发送广播和指定端口的网络端口实例
                                                                            //IPEndPoint iep1 = new IPEndPoint(IPAddress.Any, localEndPoint.Port);//初始化一个发送广播和指定端口的网络端口实例
                IPEndPoint iep1 = new IPEndPoint(IPAddress.Any, 0);
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            ...
            MsgData[0] &= 0x03;
            MsgData[0] |= 0x04;
            txt_challenge.Text = ByteArrayToHexString(MsgData);
            txt_authdata.Text = "";
            byte Auth_len = 0;
            ...
            for (int p = 0; p < 5; p++)
            {
                fCmdRet = RWDev.Authenticate_G2(ref fComAdr, EPC, ENum, sendRep, IncrepLen, CSI, MsgLen, MsgData, fPassWord,
                                                    MaskMem, MaskAdr, MaskLen, MaskData, ref Auth_len, Auth_data, ref ferrorcode, frmcomportindex);
                if (fCmdRet == 0) break;
            }
            if (fCmdRet != 0)
            {
                ...
                string strLog = "";
                if (fCmdRet == 0xFC)
                    strLog = "Auth failed: " + "Return = 0x" + Convert.ToString(ferrorcode, 16) + "(" + GetErrorCodeDesc(ferrorcode) + ")";
                else
                    strLog = "Auth failed: " + GetReturnCodeDesc(fCmdRet);
                WriteLog(lrtxtLog, strLog, 1);
            }
            else
            {
                ...
                txt_authdata.Text = ByteArrayToHexString(daw);
                string strLog = "Auth success ";
                WriteLog(lrtxtLog, strLog, 0);
            }
        }
