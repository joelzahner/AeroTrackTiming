...
public:
	...
	typedef int (__stdcall *PReadBuffer_G2)(unsigned char *ComAdr,int *Totallen,int *CardNum,unsigned char *pEPCList,int FrmHandle);
	typedef int (__stdcall *PClearBuffer_G2)(unsigned char *ComAdr,int FrmHandle);
	typedef int (__stdcall *PGetBufferCnt_G2)(unsigned char *ComAdr,int *Count,int FrmHandle);
