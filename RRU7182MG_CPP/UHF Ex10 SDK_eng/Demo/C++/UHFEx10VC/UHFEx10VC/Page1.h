...
public:
	typedef int (__stdcall *PAutoOpenComPort)(int *port, unsigned char *address,unsigned char Baud,int *Frmhandle);
	typedef int (__stdcall *POpenComPort)(int port,unsigned char *address,unsigned char Baud,int *Frmhandle);
	typedef int (__stdcall *PCloseComPort)();
	typedef int (__stdcall *PCloseSpecComPort)(int Frmhandle);

	typedef int (__stdcall *POpenNetPort)(int Port,LPSTR IPaddr,unsigned char*ComAdr,int *Frmhandle);
